...
void KeyboardMovementController::setAllMoveFlagOff(){
    camera_moving_flag.moveLeft = false;
    camera_moving_flag.moveRight = false;
    camera_moving_flag.moveForward = false;
    camera_moving_flag.moveBackward = false;
    camera_moving_flag.moveUp = false;
    camera_moving_flag.moveDown = false;
}
...
void KeyboardMovementController::moveCamera(
    ...
    if (camera_moving_flag.moveRight) rotate_lr = -0.1f * obj_scale;
    else if (camera_moving_flag.moveLeft) rotate_lr = 0.1f * obj_scale;

    if (camera_moving_flag.moveUp) rotate_ud = -0.1f * obj_scale;
    else if (camera_moving_flag.moveDown) rotate_ud = 0.1f * obj_scale;
...
void KeyboardMovementController::moveCamera(
    ...
    if (key == camera_move_key.moveRight) rotate_lr = -0.1f * obj_scale;
    if (key == camera_move_key.moveLeft) rotate_lr = 0.1f * obj_scale;
    if (key == camera_move_key.moveUp) rotate_ud = -0.1f * obj_scale;
    if (key == camera_move_key.moveDown) rotate_ud = 0.1f * obj_scale;
    //if (glfwGetMouseButton(window, camera_move_key.mouseLeft) == GLFW_PRESS) scale = 1.0f + 0.0001f * obj_scale;
    //if (glfwGetMouseButton(window, camera_move_key.mouseRight) == GLFW_PRESS) scale = 1.0f - 0.0001f * obj_scale;
